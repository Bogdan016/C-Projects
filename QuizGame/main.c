  ...
  do {
    ...
    Question questions[] = {
        ...
        {"4. Which of the following is true for variable names in C?\n",
         ...
         "characters\nb) It is not an error to declare a variable to be one of "
         "the keywords(like goto, static)\nc) Variable names cannot start with "
        ...
        {"7. What is short int in C programming?\n",
         "a) The basic data type of C\nb) Qualifier\nc) Short is the qualifier "
         "and int is the basic data type\nd) All of the mentioned",
         'c', " "},
        {"8. Which of the following declaration is not supported by C "
         "language?\n",
         "a) String str;\nb) char *str;\nc) float str = 3e2;\nd) Both “String "
         "str;” and “float str = 3e2;”\n",
        ...
        {"10. What is the result of logical or relational expression in C?\n",
         ...
         "positive number if an expression is true\nd) None of the mentioned\n",
         'b', " "}};
